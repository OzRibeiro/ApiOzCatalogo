...
namespace ApiOzCatalogo.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        private static Dictionary<Guid, Jogo> jogos = new Dictionary<Guid, Jogo>()
        {
            ...
            {Guid.Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"), new Jogo{ Id = Guid.Parse("5e99c84a-108b-4dfa-ab4e-d8c55957a7ec"), Nome = "Fifa 19", Produtora = "EA", Preco = 180} },
            ...
            {Guid.Parse("92576bd2-388e-4f5d-96c1-8bfda6c5a268"), new Jogo{ Id = Guid.Parse("92576bd2-388e-4f5d-96c1-8bfda6c5a268"), Nome = "Street Fighther V", Produtora = "Capcom", Preco = 80} },
        ...
        public Task Atualizar(JogoRepository jogo)
        {
            jogos[jogo.Id] = jogo;
            return Task.CompletedTask;
        }
        ...
        public Task Inserir(IJogoRepository jogo)
        {
            throw new NotImplementedException();
        }

        public Task Atualizar(IJogoRepository jogo)
        {
            throw new NotImplementedException();
        }

        public Task Inserir(object jogoInsert)
        {
            throw new NotImplementedException();
        }

        public Task Atualizar(Jogo entidadeJogo)
        {
            throw new NotImplementedException();
        }
    }
